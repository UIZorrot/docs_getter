---
source_url: "https://openrouter.ai/docs/api/reference/parameters"
title: "API Parameters | Configure OpenRouter API Requests | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:52.094704+00:00"
---
...
Please refer to the model’s provider section to confirm which parameters are supported. For detailed guidance on managing provider-specific parameters, [click here](../../../features/provider-routing/index.md).
...
Tool calling parameter, following OpenAI’s tool calling request shape. For non-OpenAI providers, it will be transformed accordingly. [Click here to learn more about tool calling](../../../guides/features/tool-calling/index.md)
