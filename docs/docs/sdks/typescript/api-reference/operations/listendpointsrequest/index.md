---
source_url: "https://openrouter.ai/docs/sdks/typescript/api-reference/operations/listendpointsrequest"
title: "ListEndpointsRequest Type | OpenRouter TypeScript SDK | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:30:04.047764+00:00"
---
...
|  |  |
| --- | --- |
| 1 | import { ListEndpointsRequest } from "@openrouter/sdk/models/operations"; |
| 2 |  |
| 3 | let value: ListEndpointsRequest = { |
| 4 | author: "openai", |
| 5 | slug: "gpt-4", |
| 6 | }; |
```
...
| `author` | *string* | ✔️ | The author/organization of the model | openai |
| `slug` | *string* | ✔️ | The model slug | gpt-4 |
