---
source_url: "https://openrouter.ai/docs/sdks/typescript/api-reference/operations/listguardrailkeyassignmentsresponse"
title: "ListGuardrailKeyAssignmentsResponse Type | OpenRouter TypeScript SDK | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:30:05.095960+00:00"
---
...
|  |  |
| --- | --- |
| 1 | import { ListGuardrailKeyAssignmentsResponse } from "@openrouter/sdk/models/operations"; |
| 2 |  |
| 3 | let value: ListGuardrailKeyAssignmentsResponse = { |
| 4 | result: { |
| 5 | data: [ |
| 6 | { |
