---
source_url: "https://openrouter.ai/docs/sdks/typescript/api-reference/operations/listguardrailmemberassignmentsresponse"
title: "ListGuardrailMemberAssignmentsResponse Type | OpenRouter TypeScript SDK | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:30:05.438495+00:00"
---
...
ListGuardrailMemberAssignmentsResponse type definition
...
|  |  |
| --- | --- |
| 1 | import { ListGuardrailMemberAssignmentsResponse } from "@openrouter/sdk/models/operations"; |
| 2 |  |
| 3 | let value: ListGuardrailMemberAssignmentsResponse = { |
| 4 | result: { |
| 5 | data: [ |
| 6 | { |
