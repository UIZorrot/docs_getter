---
source_url: "https://openrouter.ai/docs/sdks/python/api-reference/credits"
title: "Credits | OpenRouter Python SDK | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:43.448135+00:00"
---
...
| 9 | ) as open_router: |
| 10 |  |
| 11 | res = open_router.credits.get_credits() |
| 12 |  |
| 13 | # Handle response |
| 14 | print(res) |
```
...
**[operations.GetCreditsResponse](../operations/getcreditsresponse/index.md)**
