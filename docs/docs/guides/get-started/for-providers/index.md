---
source_url: "https://openrouter.ai/docs/guides/get-started/for-providers"
title: "Provider Integration | Add Your AI Models to OpenRouter | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:53.997551+00:00"
---
...
[Auto Exacto](../../routing/auto-exacto/index.md) is a routing step that automatically reorders providers for all requests that include tools. It runs by default on every tool-calling request and may change how much tool-calling traffic your endpoints receive.
...
Non-tool-calling traffic is **not affected** by Auto Exacto — it continues to follow the standard [price-weighted routing](../../routing/provider-selection/index.md).
...
For the full user-facing documentation on Auto Exacto, see [Auto Exacto](../../routing/auto-exacto/index.md).
