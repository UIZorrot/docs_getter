---
source_url: "https://openrouter.ai/docs/guides/overview/multimodal/overview"
title: "OpenRouter Multimodal | Complete Documentation | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:40.898787+00:00"
---
[Overview](../../../../quickstart/index.md)[Multimodal](index.md)
...
[Learn more about image inputs →](../../../../features/multimodal/images/index.md)
...
[Learn more about image generation →](../../../../features/multimodal/image-generation/index.md)
...
[Learn more about PDF processing →](../../../../features/multimodal/pdfs/index.md)
...
[Learn more about audio →](../../../../features/multimodal/audio/index.md)
...
[Learn more about video inputs →](../../../../features/multimodal/videos/index.md)
...
**Note for video URLs**: Video URL support varies by provider. For example, Google Gemini on AI Studio only supports YouTube links. See the [video inputs documentation](../../../../features/multimodal/videos/index.md) for provider-specific details.
...
Video support varies by model. Use the [Models page](https://openrouter.ai/models) to filter for video-capable models. Check each model’s documentation for specific video format and duration limits.
