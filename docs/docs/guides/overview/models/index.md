...
title: "OpenRouter Models | Access 300+ AI Models Through One API | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:55.985535+00:00"
---
...
Explore and browse 300+ models and providers [on our website](https://openrouter.ai/models), or [with our API](../../../api-reference/models/get-models/index.md). You can also subscribe to our [RSS feed](https://openrouter.ai/api/v1/models) to stay updated on new models.
...
The same parameter is available on the [`/v1/models/count`](../../../api-reference/models/count/index.md) endpoint so that counts stay consistent with list results.
...
Our [Models API](../../../api-reference/models/get-models/index.md) makes the most important information about all LLMs freely available as soon as we confirm it.
...
If you’re interested in working with OpenRouter, you can learn more on our [providers page](../../../use-cases/for-providers/index.md).
