---
source_url: "https://openrouter.ai/docs/guides/features/plugins/web-search"
title: "Web Search | Add Real-time Web Data to AI Model Responses | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:38.003894+00:00"
---
...
The web search plugin is deprecated. Use the [`openrouter:web_search` server tool](../../server-tools/web-search/index.md) instead. Server tools give the model control over when and how often to search, rather than always running once per request.
...
For other models, the web search plugin is powered by [Exa](https://exa.ai/). It uses their [“auto”](https://docs.exa.ai/reference/how-exa-search-works) method (a combination of keyword search and embeddings-based web search) to find the most relevant results and augment/ground your prompt.
...
- [Anthropic Pricing](https://docs.claude.com/en/docs/agents-and-tools/tool-use/web-search-tool)
