---
source_url: "https://openrouter.ai/docs/guides/features/broadcast/s3"
title: "Broadcast to S3 | OpenRouter Observability | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:37.223857+00:00"
---
...
| 3 | "messages": [{ "role": "user", "content": "Analyze this document..." }], |
| 4 | "user": "user_12345", |
| 5 | "session_id": "session_abc", |
| 6 | "trace": { |
| 7 | "trace_name": "Document Analysis", |
| 8 | "generation_name": "Extract Key Points", |
| 9 | "document_type": "contract", |
| 10 | "batch_id": "batch_456" |
| 11 | } |
| 12 | } |
```
...
|  |  |
| --- | --- |
| 1 | -- Example Athena query on S3 trace files |
| 2 | SELECT |
| 3 | json_extract_scalar(metadata, '$.document_type') as doc_type, |
| 4 | json_extract_scalar(metadata, '$.batch_id') as batch_id |
| 5 | FROM openrouter_traces |
| 6 | WHERE json_extract_scalar(metadata, '$.document_type') = 'contract'; |
```
