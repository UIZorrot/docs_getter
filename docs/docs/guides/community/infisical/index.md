---
source_url: "https://openrouter.ai/docs/guides/community/infisical"
title: "Infisical Integration | OpenRouter API Key Management | OpenRouter | Documentation"
crawled_at: "2026-04-08T10:29:35.413153+00:00"
---
...
For more details on Management API keys and key management, see [OpenRouter’s Management Keys documentation](../../overview/auth/management-api-keys/index.md).
...
For more details, see [OpenRouter BYOK documentation](../../../features/byok/index.md) and [OpenRouter limits documentation](../../../api/limits/index.md).
...
- **OpenRouter Management Keys**: [https://openrouter.ai/docs/guides/overview/auth/management-api-keys](../../overview/auth/management-api-keys/index.md)
